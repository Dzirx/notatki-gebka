...
# from sqlalchemy import Column, Integer, String, Text, DECIMAL, DateTime, ForeignKey, CheckConstraint, Boolean
# from sqlalchemy.orm import relationship
# from sqlalchemy.sql import func
# from database import Base
...
#     nip = Column(String(15))
#     nazwa_firmy = Column(String(255))
#     created_at = Column(DateTime, server_default=func.getdate())  # ZMIENIONE dla SQL Server
#     updated_at = Column(DateTime, server_default=func.getdate(), onupdate=func.getdate())  # ZMIENIONE
...
#     model = Column(String(100))
#     rok_produkcji = Column(Integer)
#     created_at = Column(DateTime, server_default=func.getdate())  # ZMIENIONE
#     updated_at = Column(DateTime, server_default=func.getdate(), onupdate=func.getdate())  # ZMIENIONE
...
#     __table_args__ = (
#         CheckConstraint("typ_notatki IN ('szybka', 'pojazd')", name="check_typ_notatki"),
#         CheckConstraint("status IN ('nowa', 'w_trakcie', 'zakonczona', 'dostarczona', 'klient_poinformowany')", name="check_status_notatki"),  # ZMIENIONE - zgodne z bazą
#     )
...
#     notatka_id = Column(Integer, ForeignKey("notatki.id", ondelete="CASCADE"))
#     data_przypomnienia = Column(DateTime, nullable=False)
#     wyslane = Column(Boolean, default=False)  # ZMIENIONE - używamy Boolean zamiast Integer dla SQL Server
#     created_at = Column(DateTime, server_default=func.getdate())  # ZMIENIONE
